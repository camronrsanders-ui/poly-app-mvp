  ...
  Widget build(BuildContext context) {
    final pages = <Widget>[
      _OnboardingPage(
          ...
          subtitle:
              'Use the name you want people in your circle to know you by.',
          children: [
            _field(_name, 'Display name', maxLength: 80),
            _field(_age, 'Age (18+)',
                keyboard: TextInputType.number, maxLength: 3),
      ...
      _OnboardingPage(
          ...
          subtitle:
              'Your identity belongs to you. Self-described answers are welcome.',
          children: [
      ...
      _OnboardingPage(
          ...
          subtitle:
              'Choose the relationship structure that best describes you right now. You can change this later.',
          children: [
            Wrap(
              spacing: 8,
              runSpacing: 8,
          ...
          children: [
            Wrap(
                ...
                children: connectionIntentionOptions
                    .map((i) => FilterChip(
                          label: Text(i),
                          selected: _intentions.contains(i),
                          onSelected: _busy
                              ? null
      ...
      _OnboardingPage(
          title: 'Tell your circle a little more',
          subtitle: 'Keep it genuine. You can always edit this later.',
          children: [
            _field(_bio, 'About me', maxLength: 1500),
            _field(_lookingFor, 'What are you looking for?', maxLength: 1200),
            const ListTile(
                title: Text('Relationship cards come next'),
                subtitle: Text(
                    'After onboarding, Circle lets you represent important relationships with individual privacy controls.')),
          ]),
    ];
