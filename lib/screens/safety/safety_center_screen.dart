      ...
      body: ListView(
        ...
        children: [
          ...
          _section(
            ...
            body:
                'Blocking ends interaction through Polycircle. Existing connection and chat access are closed, and any private-media access is revoked. Unblocking does not automatically restore them.',
          ),
          OutlinedButton.icon(
            onPressed: () => Navigator.of(context).push(
          ...
          _section(
            ...
            body:
                'Ending a connection closes the chat and revokes private-media sharing in both directions. The person will not silently reappear in Discover through the current reconnect flow.',
          ),
          _section(
            context,
          ...
          _section(
            ...
            body:
                'Private Vault is not available until its additional consent, moderation, retention, and security requirements pass. When enabled, sharing will require explicit consent and protected delivery.',
          ),
          _section(
            context,
            ...
            body:
                'Profile photos use a protected processing and review flow. Other permitted members receive short-lived access instead of permanent public Storage links.',
          ),
          _section(
            context,
            ...
            body:
                'The current profile uses city and region rather than publishing exact location. Share only the location detail you are comfortable putting on your profile.',
          ),
          _section(
            context,
            ...
            body:
                'A relationship card describes the account owner’s view. Naming another person does not mean that person has confirmed the relationship or consented to be represented.',
          ),
          _section(
            context,
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Could not unblock this member right now.')),
        );
      }
    } finally {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      const Text('Could not load blocked members.',
                          textAlign: TextAlign.center),
                      const SizedBox(height: 12),
                      TextButton(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    title: Text(name),
                    subtitle: const Text(
                        'Previous connections and private access stay closed.'),
                    trailing: TextButton(
                      onPressed:
                          working || uid.isEmpty ? null : () => _unblock(block),
                      child: working
